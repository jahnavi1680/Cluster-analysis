# -*- coding: utf-8 -*-
"""
Created on Sun Jun  4 17:48:48 2023

@author: jp042
"""

#in this combine all the 9 variables and do the clustering. 
...
dfnew = df[['X','Y']]
# =============================================================================
# for i in ['rain','tmax','tmin']:
#     df = pd.read_excel(r"C:\Users\jp042\Downloads\summer_project\climate data\last10years (1).xlsx", sheet_name='{}_calculated'.format(i))
...
#variables = 
sagg13cls = sagg13.fit(dfnew.iloc[:,[2,3,4,5,6,7,8,9,10]])
